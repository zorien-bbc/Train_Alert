...
import ch.berufsbildungscenter.train_alert.VerbindungDetailsActivity;
...
public class FavoritenListener implements View.OnClickListener{
    ...
    VerbindungDetailsActivity activity;
    Ort ort;
    Toast toast;
    boolean exist;
    public FavoritenListener(VerbindungDetailsActivity activity, Ort ort){
